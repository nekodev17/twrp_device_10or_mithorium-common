...
# Defines
TARGET_USES_10OR_MITHORIUM_COMMON_TREE := true
MITHORIUM_PROPRIETARY_FILES_DIR ?= $(LOCAL_PATH)/proprietary

ifeq ($(TARGET_KERNEL_VERSION),4.19)
ifneq ($(wildcard device/10or/mithorium-common-4.19/proprietary/),)
MITHORIUM_PROPRIETARY_FILES_DIR := device/10or/mithorium-common-4.19/proprietary
endif
endif
